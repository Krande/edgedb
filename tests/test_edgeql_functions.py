...
class TestEdgeQLFunctions(tb.QueryTestCase):
    ...
    async def test_edgeql_functions_duration_trunc_03(self):
        await self.assert_query_result(
            r'''
            SELECT <str>duration_truncate(
                cal::normalize_relative_duration(
    ...
    async def test_edgeql_functions_normalize_relative_duration(self):
        ...
        await self.assert_query_result(
            r'''select cal::normalize_relative_hours(
        ...
        await self.assert_query_result(
            r'''select cal::normalize_relative_days(
        ...
        await self.assert_query_result(
            r'''select cal::normalize_relative_duration(
                <cal::relative_duration>'30240000 seconds');''',
            ['P11M20D'],
            [edgedb.RelativeDuration(months=11, days=20)],
        )
